...
function PortfolioListController( $scope ){
		...
		$scope.portfolios = [
		{name: 'vessel1309', title: 'Call of Bootyy', date: '2013-09-01', description: 'Arrrgh mateys! This be the finest vessel sailing these seas that yer eyes ever laid sight on. Arrrgh.', imageurl: 'images/drunkenPirate_thumb3.png' },
